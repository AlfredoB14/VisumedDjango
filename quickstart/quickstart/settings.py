...
if CORS_ALLOW_VERCEL_PREVIEWS and r'^https://visu-med-v3.*\.vercel\.app$' not in CORS_ALLOWED_ORIGIN_REGEXES:
    CORS_ALLOWED_ORIGIN_REGEXES.append(r'^https://visu-med-v3.*\.vercel\.app$')
