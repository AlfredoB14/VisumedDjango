...
def get_study_images(request, study_id):
    """Devuelve todas las imágenes de un estudio ordenadas por serie e instancia."""
    try:
        ...
        # Obtener todos los IDs de series únicos
        ...
        # Ordenar por SeriesNumber y luego por InstanceNumber
...
def get_rendered_instance(request, instance_id):
    """Devuelve una imagen renderizada de una instancia DICOM específica."""
    try:
...
def get_study_metadata(request, study_id):
    ...
    try:
        ...
        # Obtener etiquetas DICOM compartidas
...
def get_all_studies(request):
    ...
    try:
        ...
        # Si se pasa ?expand=true, devuelve detalles de cada estudio
