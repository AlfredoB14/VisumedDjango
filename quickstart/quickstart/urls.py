...
from orthanc.clinical.views import StudyUploadView

docs_patterns = [
    path('api/', include('orthanc.docs_urls')),
]
...
schema_view = get_schema_view(
    openapi.Info(
        title='Visumed API',
        default_version='v1',
        description='Documentacion de endpoints para el proyecto VisumedDjango',
    ),
    public=True,
